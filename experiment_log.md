...
- **推荐**: 0.4695 → 0.4952 (提升0.026, 主要来自用户特征+GRU4Rec+SASRec集成)
- **总分**: 0.5163 → 0.6066 (最佳#9, 提升0.09)
- **距榜首**: 0.0325 (分类差0.046, 推荐差0.015)

### 关键发现(提交#14)
- **推荐集成有效**: GRU4Rec+SASRec(0.6:0.4) → 0.4952 (新最佳, +0.004)
- **标签传播0.5有害**: 分类0.7201→0.7139 (-0.006), 应回退到0.4
- **最优组合**: 分类标签传播0.4(0.7201) + 推荐集成(0.4952) = 预估0.6127
